...
export default function HeaderH() {
    return (
        <section className='lg:py-32 sm:py-16 sm:px-10 py-10 px-4 lg:px-20 gap-16 grid grid-cols-1 sm:grid-cols-2 '>
            <div className='flex flex-col gap-6'>
                ...
                <div className='bg-primary '>
                    ...
                    <button className='text-white antialiased tracking-wide font-bold text-sm w-5/12  py-2 px-3 lg:px-6 lg:py-3'>Subscribe</button>
                </div>
            </div>
